...
enum AppTheme {
    ...
    static let redAccent = Color(nsColor: NSColor(calibratedRed: 0.98, green: 0.35, blue: 0.34, alpha: 1))
    static let redAccentSoft = Color(nsColor: NSColor(calibratedRed: 0.28, green: 0.12, blue: 0.14, alpha: 1))
    static let redAccentBorder = Color(nsColor: NSColor(calibratedRed: 0.60, green: 0.22, blue: 0.24, alpha: 0.9))
